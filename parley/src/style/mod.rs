...
impl<B: Brush> Default for TextStyle<'_, B> {
    fn default() -> Self {
        TextStyle {
            ...
            locale: Option::default(),
            brush: Default::default(),
            has_underline: Default::default(),
            underline_offset: Option::default(),
            underline_size: Option::default(),
            underline_brush: Option::default(),
            has_strikethrough: Default::default(),
            strikethrough_offset: Option::default(),
            strikethrough_size: Option::default(),
            strikethrough_brush: Option::default(),
