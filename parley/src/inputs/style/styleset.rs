...
///
/// This is used by [`PlainEditor`](crate::outputs::editor::PlainEditor) to provide a reasonably ergonomic
/// mutable API for styles applied to all text managed by it.
/// This can be accessed using [`PlainEditor::edit_styles`](crate::outputs::editor::PlainEditor::edit_styles).
///
