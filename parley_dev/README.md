...
- The font file `NotoSansCJKsc-Regular-subset.otf` in `./assets/noto_fonts/` is licensed solely as documented in that folder (and is licensed under the SIL Open Font License, Version 1.1).
