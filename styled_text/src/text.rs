...
impl<T: Debug + TextStorage, A: Debug> StyledText<T, A> {
    ...
    ///
    /// The base styles also serve as the "initial" values for [`text_style::Specified::Initial`].
    pub fn new(
        text: T,
    ...
    pub fn apply_span(&mut self, range: Range<usize>, attribute: A) -> Result<(), Error> {
